...
type AddressService interface {
	...
	Add(tenantId system.UUID, address domain.Address) (system.UUID, error)
	...
	Update(tenantId system.UUID, id system.UUID, address domain.Address) error
	...
	Get(tenantId system.UUID, id system.UUID) (domain.Address, error)

	// Removes an existing address information.
	// tenantId: Mandatory. The unique identifier of the tenant owning the address.
	// id: Mandatory. The unique identifier of the existing address to remove.
	// Returns error if something goes wrong.
	Remove(tenantId system.UUID, id system.UUID) error
}
